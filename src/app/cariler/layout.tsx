...
function CarilerSidebar({ isOpen, toggleSidebar }: CarilerSidebarProps) {
...
export default function CarilerLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="sidebar-layout">
      {/* Cariler Sidebar */}
      <CarilerSidebar isOpen={sidebarOpen} toggleSidebar={toggleSidebar} />
