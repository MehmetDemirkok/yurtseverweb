...
export default function SidebarLayout({ children }: { children: React.ReactNode }) {
  ...
  // Login, no-access, dashboard, transfer modülü, cariler, tedarikçiler ve admin sayfalarında sidebar'ı gösterme
  if (pathname === '/login' || pathname === '/no-access' || pathname === '/dashboard' || pathname.startsWith('/moduller/transfer') || pathname === '/cariler' || pathname === '/tedarikciler' || pathname === '/admin' || pathname.startsWith('/admin/')) {
    return (
